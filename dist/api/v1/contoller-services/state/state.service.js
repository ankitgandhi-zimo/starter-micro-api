...
var StateServices = /** @class */ (function () {
    function StateServices() {
        var _this = this;
        this.addState = function (req, model, next) { return __awaiter(_this, void 0, void 0, function () {
            var userDetails, alreadyPresentState, saveStateResult, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, state_model_1.default.findOne(model)];
                    case 1:
                        alreadyPresentState = _a.sent();
                        if (!alreadyPresentState) return [3 /*break*/, 2];
                        return [2 /*return*/, {
                                success: false,
                                data: {
                    ...
                    case 2: return [4 /*yield*/, state_model_1.default.create(model)];
                    case 3:
                        saveStateResult = _a.sent();
                        if (saveStateResult) {
                            ...
                            return [2 /*return*/, {
                                    success: false,
                                    data: {
                                        message: erros_message_1.default.ERROR_ON_ADD_STATE,
                                        error: erros_message_1.default.ON_ADD_ERROR,
                                    },
                                    status_code: http_status_codes_1.default.BAD_REQUEST,
                                }];
        ...
        this.updateState = function (req, model, next) { return __awaiter(_this, void 0, void 0, function () {
            var userDetails, alreadyPresentState, updateStateResult, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                        userDetails = req.user;
                        return [4 /*yield*/, state_model_1.default.findOne({
                    ...
                    case 2: return [4 /*yield*/, state_model_1.default.findOneAndUpdate({ _id: model._id }, model, {
                            new: true,
                        })];
                    case 3:
                        updateStateResult = _a.sent();
        ...
        this.deleteState = function (req, model, next) { return __awaiter(_this, void 0, void 0, function () {
            var userDetails, deleteStateResult, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        userDetails = req.user;
                        return [4 /*yield*/, state_model_1.default.updateOne({ _id: req.params._id }, { isDeleted: true })];
                    case 1:
                        ...
                        if (deleteStateResult && deleteStateResult.modifiedCount > 0) {
                            ...
                            return [2 /*return*/, {
                                    success: false,
                                    data: {
                                        message: erros_message_1.default.ERROR_ON_DELETE_STATE,
        ...
        this.getState = function (req, model, next) { return __awaiter(_this, void 0, void 0, function () {
            var getStateResult, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        ...
                        if (getStateResult) {
                            ...
                            return [2 /*return*/, {
                                    success: false,
                                    data: {
                                        message: erros_message_1.default.ERROR_ON_GET_STATE,
        ...
        this.listState = function (req, model, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, state_model_1.default.paginate(condition, __assign(__assign({ page: defaultPage }, (count > 0 ? { limit: count } : { pagination: false })), { populate: populateFeilds, sort: { createdAt: -1 } }))];
                    case 1:
                        result = _a.sent();
                        if (result && result.docs && result.docs.length > 0) {
                            ...
                            return [2 /*return*/, {
                                    ...
                                    success: false,
                                    data: {
                                        message: erros_message_1.default.STATE_LIST_NOT_FOUND,
                                        error: erros_message_1.default.ON_FETCH_ERROR,
                                    },
                                }];
                        }
        ...
        this.filterListState = function (req, model, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, state_model_1.default.find(condition, {
                                createdAt: 0,
                                updatedAt: 0,
                                isActive: 0,
                                isDeleted: 0,
...
exports.default = new StateServices();
