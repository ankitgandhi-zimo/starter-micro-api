...
var superBillOtherDetail_1 = require("../../view-models/superBillOtherDetail");
var superBillOtherDetail_service_1 = __importDefault(require("./superBillOtherDetail.service"));
var SuperBillOtherDetail_Controller = /** @class */ (function () {
    function SuperBillOtherDetail_Controller() {
        var _this = this;
        this.addSuperBillOtherDetail = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var conversionResult, model, addSuperBillResult, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                        return [4 /*yield*/, common_methods_1.default.ValidateAndConvert(superBillOtherDetail_1.AddSuperBillOtherDetailViewmodel, req.body)];
                    case 1:
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, superBillOtherDetail_service_1.default.addSuperBillOtherDetail(req, model, next)];
                    case 3:
        ...
        this.updateSuperBillOtherDetail = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var conversionResult, model, updateSuperBillResult, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                        return [4 /*yield*/, common_methods_1.default.ValidateAndConvert(superBillOtherDetail_1.UpdateSuperBillOtherDetailViewmodel, req.body)];
                    case 1:
                        conversionResult = _a.sent();
                        if (!(conversionResult.error && conversionResult.error.length > 0)) return [3 /*break*/, 2];
                        return [2 /*return*/, res.status(http_status_codes_1.default.OK).send({
                    ...
                    case 2:
                        model = conversionResult.data;
                        return [4 /*yield*/, superBillOtherDetail_service_1.default.updateSuperBillOtherDetail(req, model, next)];
                    case 3:
        ...
        this.getSuperBillOtherDetail = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        model = conversionResult.data;
                        return [4 /*yield*/, superBillOtherDetail_service_1.default.getSuperBillOtherDetail(req, model, next)];
                    case 3:
        ...
        this.deleteSuperBillOtherDetail = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var conversionResult, model, deleteSuperBillResult, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                    ...
                    case 2:
                        model = conversionResult.data;
                        return [4 /*yield*/, superBillOtherDetail_service_1.default.deleteSuperBillOtherDetail(req, model, next)];
                    case 3:
    ...
    return SuperBillOtherDetail_Controller;
}());
exports.default = new SuperBillOtherDetail_Controller();
