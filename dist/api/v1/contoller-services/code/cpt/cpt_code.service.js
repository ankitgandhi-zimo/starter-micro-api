...
var CptCodeServices = /** @class */ (function () {
    function CptCodeServices() {
        var _this = this;
        this.addCptCode = function (req, model, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, cpt_model_1.default.findOne(model)];
                    case 1:
                        ...
                        return [2 /*return*/, {
                                success: false,
                                data: {
                                    message: erros_message_1.default.ALREADY_EXIST_CPT_CODE,
                                    error: erros_message_1.default.ON_ADD_ERROR,
                                },
                                status_code: http_status_codes_1.default.BAD_REQUEST,
                            }];
                    case 2: return [4 /*yield*/, cpt_model_1.default.create(model)];
                    case 3:
                        saveCodeResult = _a.sent();
                        return [4 /*yield*/, cpt_model_1.default.findOne({
                    ...
                    case 6: return [2 /*return*/, {
                            success: false,
                            data: {
                                message: erros_message_1.default.ERROR_ON_ADD_CPT_CODE,
                                error: erros_message_1.default.ON_ADD_ERROR,
                            },
                            status_code: http_status_codes_1.default.BAD_REQUEST,
                        }];
        ...
        this.updateCptCode = function (req, model, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, cpt_model_1.default.updateOne({ _id: model._id }, model, {
                                new: true,
                            })];
                    case 2:
                    ...
                    case 4: return [2 /*return*/, {
                            success: false,
                            data: {
                                message: erros_message_1.default.ERROR_ON_UPDATE_CPT_CODE,
                                error: erros_message_1.default.ON_UPDATE_ERROR,
                            },
                            status_code: http_status_codes_1.default.BAD_REQUEST,
                        }];
        ...
        this.deleteCptCode = function (req, model, next) { return __awaiter(_this, void 0, void 0, function () {
            var userDetails, deleteCptCodeResult, addHistory, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                        userDetails = req.user;
                        return [4 /*yield*/, cpt_model_1.default.updateOne({ _id: req.params._id }, { isDeleted: true })];
                    case 1:
                        deleteCptCodeResult = _a.sent();
                        if (!(deleteCptCodeResult &&
                            deleteCptCodeResult.modifiedCount > 0)) return [3 /*break*/, 3];
                        return [4 /*yield*/, history_model_1.default.create({
                                user_id: userDetails._id,
                    ...
                    case 3: return [2 /*return*/, {
                            success: false,
                            data: {
                                message: erros_message_1.default.ERROR_ON_DELETE_CPT_CODE,
        ...
        this.getCptCode = function (req, model, next) { return __awaiter(_this, void 0, void 0, function () {
            var getCptCodeResult, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        ...
                        if (getCptCodeResult) {
                            ...
                            return [2 /*return*/, {
                                    success: false,
                                    data: {
                                        message: erros_message_1.default.ERROR_ON_GET_CPT_CODE,
        ...
        this.listCptCode = function (req, model, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, cpt_model_1.default.paginate(condition, __assign(__assign({ page: defaultPage }, (count > 0
                                ? { limit: count }
        ...
        this.filterListCptCode = function (req, model, next) { return __awaiter(_this, void 0, void 0, function () {
        ...
        // Download CPT Data
        this.getCptCodeDataToExcel = function (req, model, next) { return __awaiter(_this, void 0, void 0, function () {
            var workbook, cptCodeSheet_1, cptCodeSheetHeader, defaultPage, count, populateFeilds, condition, isEmptyNameOnlySpace, result, cptCodeData, sheetStyle_1, data, link, excelFileName, response, error_7;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 7, , 8]);
                    ...
                    case 1:
                        workbook = _a.sent();
                        cptCodeSheet_1 = workbook.sheet("Sheet1");
                        cptCodeSheetHeader = [
                            "Code",
                            "Description",
                            "Pricing",
                        ...
                        cptCodeSheetHeader.forEach(function (el, i) {
                            cptCodeSheet_1
                    ...
                    case 2:
                        ...
                        cptCodeData = result.docs;
                        sheetStyle_1 = {
                            border: true,
                            fontFamily: "Calibri",
                        };
                        console.log(cptCodeData, "fdf");
                        cptCodeData.forEach(function (el, i) {
                            cptCodeSheet_1
                                .cell("A" + (i + 2))
                                .value(el.cptCode)
                                .style(sheetStyle_1);
                        ...
                        cptCodeSheet_1.freezePanes(1, 1);
                        return [4 /*yield*/, workbook.outputAsync()];
                    case 3:
                        data = _a.sent();
                        return [4 /*yield*/, fs_1.default.writeFileSync(path_1.default.join(__dirname, "../../../../../../public/upload/codes/CPT_Code_Report.xlsx"), data)];
                    case 4:
                        _a.sent();
                        link = "http://".concat(req.hostname, ":").concat(process.env.PORT, "/upload/codes/CPT_Code_Report.xlsx");
                        excelFileName = "CPT_Code_Report.xlsx";
                        response = {
                            link: link,
                            name: excelFileName,
                        };
    ...
    return CptCodeServices;
}());
exports.default = new CptCodeServices();
