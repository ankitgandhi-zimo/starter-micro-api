...
var IcdCodeServices = /** @class */ (function () {
    function IcdCodeServices() {
        var _this = this;
        this.addIcdCode = function (req, model, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ict_model_1.default.findOne({
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                success: false,
                                data: {
                                    message: erros_message_1.default.ALREADY_EXIST_ICD_CODE,
                                    error: erros_message_1.default.ON_ADD_ERROR,
                                },
                                status_code: http_status_codes_1.default.BAD_REQUEST,
                            }];
                    case 2: return [4 /*yield*/, ict_model_1.default.create(model)];
                    case 3:
                    ...
                    case 6: return [2 /*return*/, {
                            success: false,
                            data: {
                                message: erros_message_1.default.ERROR_ON_ADD_ICD_CODE,
                                error: erros_message_1.default.ON_ADD_ERROR,
                            },
                            status_code: http_status_codes_1.default.BAD_REQUEST,
                        }];
        ...
        this.updateIcdCode = function (req, model, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, ict_model_1.default.updateOne({ _id: model._id }, model, {
                                new: true,
                            })];
                    case 2:
                        updateCodeResult = _a.sent();
                        if (!(updateCodeResult && updateCodeResult.modifiedCount > 0)) return [3 /*break*/, 4];
                        return [4 /*yield*/, history_model_1.default.create({
                    ...
                    case 4: return [2 /*return*/, {
                            success: false,
                            data: {
                                message: erros_message_1.default.ERROR_ON_UPDATE_ICD_CODE,
                                error: erros_message_1.default.ON_UPDATE_ERROR,
                            },
                            status_code: http_status_codes_1.default.BAD_REQUEST,
                        }];
        ...
        this.deleteIcdCode = function (req, model, next) { return __awaiter(_this, void 0, void 0, function () {
            var userDetails, deleteIcdCodeResult, addHistory, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                        userDetails = req.user;
                        return [4 /*yield*/, ict_model_1.default.updateOne({ _id: req.params._id }, { isDeleted: true })];
                    case 1:
                        deleteIcdCodeResult = _a.sent();
                        if (!(deleteIcdCodeResult && deleteIcdCodeResult.modifiedCount > 0)) return [3 /*break*/, 3];
                        return [4 /*yield*/, history_model_1.default.create({
                                user_id: userDetails._id,
                    ...
                    case 3: return [2 /*return*/, {
                            success: false,
                            data: {
                                message: erros_message_1.default.ERROR_ON_DELETE_ICD_CODE,
        ...
        this.getIcdCode = function (req, model, next) { return __awaiter(_this, void 0, void 0, function () {
            var getIcdCodeResult, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        ...
                        if (getIcdCodeResult) {
                            ...
                            return [2 /*return*/, {
                                    success: false,
                                    data: {
                                        message: erros_message_1.default.ERROR_ON_GET_ICD_CODE,
        ...
        this.listIcdCode = function (req, model, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ict_model_1.default.paginate(condition, __assign(__assign({ page: defaultPage }, (count > 0 ? { limit: count } : { pagination: false })), { populate: populateFeilds, select: { createdby_id: 0, __v: 0 }, sort: { createdAt: -1 } }))];
                    case 1:
                        result = _a.sent();
                        if (result && result.docs && result.docs.length > 0) {
                            ...
                            return [2 /*return*/, {
                                    ...
                                    success: false,
                                    data: {
                                        message: erros_message_1.default.ICD_CODE_LIST_NOT_FOUND,
                                        error: erros_message_1.default.ON_FETCH_ERROR,
                                    },
                                }];
                        }
        ...
        this.getIcdCodeDataToExcel = function (req, model, next) { return __awaiter(_this, void 0, void 0, function () {
            var workbook, icdCodeSheet_1, icdCodeSheetHeader, defaultPage, count, populateFeilds, condition, isEmptyNameOnlySpace, result, icdCodeData, sheetStyle_1, data, link, excelFileName, response, error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 7, , 8]);
                    ...
                    case 1:
                        workbook = _a.sent();
                        icdCodeSheet_1 = workbook.sheet("Sheet1");
                        icdCodeSheetHeader = ["Code", "Category", "Description", "Status"];
                        icdCodeSheetHeader.forEach(function (el, i) {
                            icdCodeSheet_1
                    ...
                    case 2:
                        ...
                        icdCodeSheet_1.freezePanes(1, 1);
                        return [4 /*yield*/, workbook.outputAsync()];
                    case 3:
                        data = _a.sent();
                        return [4 /*yield*/, fs_1.default.writeFileSync(path_1.default.join(__dirname, "../../../../../../public/upload/codes/ICD_Code_Report.xlsx"), data)];
                    case 4:
                        _a.sent();
                        link = "http://".concat(req.hostname, ":").concat(process.env.PORT, "/upload/codes/ICD_Code_Report.xlsx");
                        excelFileName = "ICD_Code_Report.xlsx";
                        response = {
                            link: link,
                            name: excelFileName,
                        };
    ...
    return IcdCodeServices;
}());
exports.default = new IcdCodeServices();
