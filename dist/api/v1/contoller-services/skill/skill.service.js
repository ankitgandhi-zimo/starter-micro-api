...
var SkillServices = /** @class */ (function () {
    function SkillServices() {
        var _this = this;
        this.addSkill = function (req, model, next) { return __awaiter(_this, void 0, void 0, function () {
            var userDetails, alreadyPresentSkill, saveSkillResult, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, skill_model_1.default.findOne(model)];
                    case 1:
                        alreadyPresentSkill = _a.sent();
                        if (!alreadyPresentSkill) return [3 /*break*/, 2];
                        return [2 /*return*/, {
                                success: false,
                                data: {
                                    message: erros_message_1.default.ALREADY_EXIST_SKILL,
                                    error: erros_message_1.default.ON_ADD_ERROR,
                                },
                                status_code: http_status_codes_1.default.BAD_REQUEST,
                            }];
                    case 2: return [4 /*yield*/, skill_model_1.default.create(model)];
                    case 3:
                        saveSkillResult = _a.sent();
                        if (saveSkillResult) {
        ...
        this.updateSkill = function (req, model, next) { return __awaiter(_this, void 0, void 0, function () {
            var userDetails, alreadyPresentSkill, updateSkillResult, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                        userDetails = req.user;
                        return [4 /*yield*/, skill_model_1.default.findOne({
                    ...
                    case 2: return [4 /*yield*/, skill_model_1.default.findOneAndUpdate({ _id: model._id }, model, {
                            new: true,
                        })];
                    case 3:
                        updateSkillResult = _a.sent();
                        if (updateSkillResult) {
                            ...
                            return [2 /*return*/, {
                                    success: false,
                                    data: {
                                        message: erros_message_1.default.ERROR_ON_UPDATE_SKILL,
        ...
        this.deleteSkill = function (req, model, next) { return __awaiter(_this, void 0, void 0, function () {
            var userDetails, deleteSkillResult, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        userDetails = req.user;
                        return [4 /*yield*/, skill_model_1.default.updateOne({ _id: req.params._id }, { isDeleted: true })];
                    case 1:
                        ...
                        if (deleteSkillResult && deleteSkillResult.modifiedCount > 0) {
                            ...
                            return [2 /*return*/, {
                                    success: false,
                                    data: {
                                        message: erros_message_1.default.ERROR_ON_DELETE_SKILL,
        ...
        this.getSkill = function (req, model, next) { return __awaiter(_this, void 0, void 0, function () {
            var getSkillResult, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        ...
                        if (getSkillResult) {
                            ...
                            return [2 /*return*/, {
                                    success: false,
                                    data: {
                                        message: erros_message_1.default.ERROR_ON_FETCHING_SKILL,
        ...
        this.listSkill = function (req, model, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, skill_model_1.default.paginate(condition, __assign(__assign({ page: defaultPage }, (count > 0 ? { limit: count } : { pagination: false })), { populate: populateFeilds, sort: { createdAt: -1 } }))];
                    case 1:
                        result = _a.sent();
                        if (result && result.docs && result.docs.length > 0) {
                            ...
                            return [2 /*return*/, {
                                    ...
                                    success: false,
                                    data: {
                                        message: erros_message_1.default.SKILL_LIST_NOT_FOUND,
                                        error: erros_message_1.default.ON_FETCH_ERROR,
                                    },
                                }];
                        }
        ...
        this.filterListSkill = function (req, model, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, skill_model_1.default.find(condition, {
                                createdAt: 0,
                                updatedAt: 0,
                                __v: 0,
                            }).sort({ createdAt: -1 })];
...
exports.default = new SkillServices();
