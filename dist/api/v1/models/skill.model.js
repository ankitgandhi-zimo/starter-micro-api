...
var Skill = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, typegoose_1.prop)({ ref: "Users", type: mongoose_1.default.Types.ObjectId }),
        __metadata("design:type", Object)
    ], Skill.prototype, "createdby_id", void 0);
    Skill = __decorate([
        (0, typegoose_1.index)({ skillName: "text" })
    ], Skill);
    return Skill;
}(pagination_configuration_1.PaginatedModel));
exports.Skill = Skill;
var SKILL_DB_MODEL = (0, typegoose_1.getModelForClass)(Skill, {
    schemaOptions: {
        collection: "skill",
        timestamps: true,
    },
});
exports.default = SKILL_DB_MODEL;
