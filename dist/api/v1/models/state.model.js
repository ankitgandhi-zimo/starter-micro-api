...
var States = /** @class */ (function (_super) {
    ...
    ], States.prototype, "isDeleted", void 0);
    __decorate([
    ...
    ], States.prototype, "createdby_id", void 0);
    __decorate([
        (0, typegoose_1.prop)({ ref: "Country", type: mongoose_1.default.Types.ObjectId }),
        __metadata("design:type", Object)
    ], States.prototype, "countryId", void 0);
    States = __decorate([
        (0, typegoose_1.index)({ stateName: "text" })
    ], States);
    return States;
}(pagination_configuration_1.PaginatedModel));
exports.States = States;
var STATE_DB_MODEL = (0, typegoose_1.getModelForClass)(States, {
    schemaOptions: {
        collection: "states",
        timestamps: true,
    },
});
exports.default = STATE_DB_MODEL;
