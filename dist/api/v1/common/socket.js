...
exports.EnumSocketEvents = void 0;
// const environment = process.env.NODE_ENV,
var socketEvents = require("../common/erros_message").socketEvents, 
...
var EnumSocketEvents;
(function (EnumSocketEvents) {
    EnumSocketEvents["ADD_USER"] = "ADD_USER";
    EnumSocketEvents["REMOVE_USER"] = "REMOVE_USER";
    EnumSocketEvents["ANNOUNCEMENT"] = "ANNOUNCEMENT";
})(EnumSocketEvents = exports.EnumSocketEvents || (exports.EnumSocketEvents = {}));
var Socket = /** @class */ (function () {
    function Socket() {
        this.connectSocket = function (server) {
            ...
            return { socketIO: io, chatIO: chatIO };
        };
    }
    return Socket;
}());
